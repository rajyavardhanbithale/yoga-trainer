                ...
                <DialogContent>
                    <DialogHeader className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-lg text-slate-600 mt-1">
                                To save your personalized yoga training data, please log in
                                to your account. If you prefer, you can continue without logging in,
                                but your data won&apos;t be saved for future sessions. Check the box below if
                                you&apos;d like to skip this prompt next time.
                            </DialogDescription>
                        </div>
                    </DialogHeader>
                    ...
                    <DialogFooter className="flex justify-end gap-4 mt-6">
                        <Button
                            ...
                            type="button" className="bg-blue-900 hover:bg-blue-950 duration-700">
                            Continue Without Logging In
                        </Button>
                        <Link href={'/login'}>
                            <Button type="button" className="bg-blue-900 hover:bg-blue-950 duration-700">
                                Log In
                            </Button>
                        </Link>
                    </DialogFooter>

        ...
        <>
            <div className="w-full flex flex-col gap-5 p-5 m-5">
                <div className="w-full flex gap-10">
                    ...
                    <div className="w-1/2 flex flex-col text-center gap-2">
                        <span className="text-xl font-semibold">Audio Speed</span>
                        <div>
                            <AudioSpeed />
                        </div>
                    </div>
                ...
                <div className="w-full flex gap-10">
                    ...
                    <div className="w-1/2 flex flex-col  text-center gap-2">
                        <span className="text-xl font-semibold">Ambient Music</span>
                        <div>
                            <RelaxMusic />
                        </div>
                    </div>
                ...
                <div className="w-1/2 flex flex-col justify-center mx-auto">
                    <div className="w-full">
                        ...
                        <VolumeSlider defaultValue={[33]} max={100} step={1} />
                    </div>
                    <span className="text-xl font-semibold">Tips</span>
                </div>
            </div>

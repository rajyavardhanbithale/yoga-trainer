...
export default function Benefits() {
    ...
    const benefits = useSelector((state: RootState) => state.practiceSlice.poseData?.benefits)
    const name = useSelector((state: RootState) => state.practiceSlice.poseData?.name)
    const audioState = useSelector((state: RootState) => state.practiceSlice.audioState)

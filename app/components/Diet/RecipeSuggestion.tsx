...
export default function RecipeSuggestion() {
    ...
    const showCase: RecipeSuggestion[] = recipes.map((rec) => ({
        name: rec.name,
        image: rec.image,
    }))
                    ...
                    <CarouselContent className="mx-auto">
                        {showCase.map((rec, idx) => (
                            ...
                            >
                                <div
                                    key={idx}
                                    className="w-52 h-52 ml-2 sm:ml-0 bg-blue-950 rounded-2xl flex flex-col gap-3 items-center "
                                >
                                    ...
                                    <span className="text-xl line-clamp-2 text-slate-50 px-2 text-center font-bold">
                                        {rec.name}
                                    </span>
                                </div>
                            </CarouselItem>

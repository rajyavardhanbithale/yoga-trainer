    ...
    return (
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Select avatar for your profile</DialogTitle>
                        <DialogDescription>
                            <div className="flex flex-wrap justify-center p-4">
                                {avatarFilenames.map((filename, index) => (
                                    <div key={index} className="w-1/3 sm:w-1/3 p-2">
                                        <div
                                            ...
                                            <Image
                                                ...
                                                sizes="100wv"
                                                src={`/avatar/${filename}`}
                                                onClick={() => dispatch(updateProfilePic(filename.split('/')[1].split('.')[0]))}
                                                alt="Avatar"

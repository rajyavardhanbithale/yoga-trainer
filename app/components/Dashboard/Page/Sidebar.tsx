...
export default function Sidebar() {
    ...
    return (
        <>
            <div className={`${raleway.className} h-screen sticky top-0 bg-gradient-to-b from-gray-800 via-blue-800 to-blue-900 text-white flex flex-col w-64 shadow-lg`}>
                <div className="flex flex-col mt-8 items-center justify-center">
                    <img
                        ...
                        className="w-16 mb-3"
                    />
                    <span className={`${comfortaa.className} text-3xl font-extrabold`}>RAGE AI</span>
                </div>

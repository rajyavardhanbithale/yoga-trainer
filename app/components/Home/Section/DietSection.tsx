    ...
    return (
        <>
            <div className="sm:w-3/4 w-11/12 mx-auto flex flex-col justify-center items-center gap-6 py-10">
                <Title>
                    Discover Healthy Delights with RAGE AI
                </Title>
                <Description>
                    Explore Our Healthy Food Showcase
                </Description>


                <Description>
                    Discover delicious and nutritious recipes in our Healthy Food Showcase.
                    Like, explore detailed info,
                    watch videos, and connect with a community of health enthusiasts.
                </Description>

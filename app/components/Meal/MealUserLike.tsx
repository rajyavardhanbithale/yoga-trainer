...
export default function MealUserLike(props: { mealId: number, mealLike: number | undefined }) {
    ...
    return (
        <>
            {status === 'success' ? (
                <div
                    className='cursor-pointer my-2 flex items-center align-middle gap-2 bg-slate-100 w-fit px-2 py-1 rounded-xl hover:scale-110 duration-500'>
                    {localLike ?
                        <FcLike
                ...
                <div
                    className='cursor-pointer my-2 flex items-center align-middle gap-2 bg-slate-100 w-fit px-2 py-1 rounded-xl hover:scale-110 animate-pulse duration-1000'>
                    {localLike ?
                        <FcLike
                            className="text-3xl mb-1" />
                        :

...
export const metadata: Metadata = {
    title: "RAGE AI",
    description: "RAGE AI: Personalized yoga guidance, real-time feedback, and progress tracking to enhance your practice. Explore now!",
    generator: "Next.js",
    ...
    authors: [
        { name: "Rajyavardhan Bithale", url: "https://github.com/rajyavardhanbithale" },
    ],
